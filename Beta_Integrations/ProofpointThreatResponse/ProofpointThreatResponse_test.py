...
from ProofpointThreatResponse import get_incident_field_context, get_emails_context, pass_sources_list_filter, \
...
def test_get_incident_field_context(incident, answer):
    incident_field_values = get_incident_field_context(incident)
...
# def test_list_incidents_command(mocker):
#     mocker.patch.object(ProofpointThreatResponse, 'get_incidents_request', return_value=[MOCK_INCIDENT])
#     mocker.patch.object(demisto, 'args', return_value=demisto_args)
#
#     list_incidents_result = list_incidents_command()
#     assert list_incidents_result is None
