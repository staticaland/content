...
class TestFilterKeys:
    def test_keys_not_selected_metadata_include(self, mocker, datadir):
    ...
    def test_keys_not_selected_metadata_not_include(self, mocker, datadir):
        from MISP_V2 import demisto, filter_misp_response
        import json
        mocker.patch.object(demisto, 'params')
        demisto.params.return_value = {
    ...
    def test_keys_selected_metadata_include(self, mocker, datadir):
        from MISP_V2 import demisto, filter_misp_response
        import json
        mocker.patch.object(demisto, 'params')
        demisto.params.return_value = {
    ...
    def test_keys_selected_metadata_not_include(self, mocker, datadir):
        from MISP_V2 import demisto, filter_misp_response
        import json
        mocker.patch.object(demisto, 'params')
        demisto.params.return_value = {
